...
\end{itemize}
%
All three methods output the normalised polarizability tensor and effective depolarization factors
...
\begin{itemize}
    ...
    \item All scripts assume they are run from the \texttt{espol-cuboids/} directory.
